			...
			case 'KINGBLACKDRAGON': {
				...
				while (loot.length !== 5) {
					...
					if (!loot.includes('DV') && roll(5000)) {
						loot.push('DV');
						lootMSG.push(`**Draconic Visage:** ${kc.toLocaleString()} KC <:Draconic_visage:403378090979491840>`);
					}
					if (!loot.includes('PET') && roll(3000)) {
						loot.push('PET');
					...
					if (!loot.includes('DP') && roll(1500)) {
						loot.push('DP');
						lootMSG.push(`**Dragon Pickaxe:** ${kc.toLocaleString()} KC <:Dragon_pickaxe:406000287841779716>`);
					}
					if (roll(64)) {
						...
						if (!loot.includes('DM') && randomRoll === 2) {
							loot.push('DM');
							lootMSG.push(`**Dragon Med Helm:** ${kc.toLocaleString()} KC <:Dragon_med_helm:409997161145565185>`);
						}
					}
				}
				return msg.send(`
				...
				while (loot.length !== 10) {
					...
					if (supLoot.length !== 4) {
						...
						if (!loot.includes('DA') && roll(128)) {
							...
							rexLoot.push('DA');
							primeLoot.push('DA');
							lootMSG.push(`**Dragon Axe:** ${supKC.toLocaleString()} Supreme KC <:Dragon_axe:405265921309933588>`);
						}
					}
					if (rexLoot.length !== 4) {
						rexKC++;
						if (!loot.includes('RPET') && roll(5000)) {
							loot.push('RPET');
							rexLoot.push('RPET');
							lootMSG.push(`**Pet Dagannoth Rex:** ${rexKC.toLocaleString()} Rex KC <:Pet_dagannoth_rex:324127377091330049>`);
						}
						if (roll(64)) {
							const randomRoll = Math.floor(Math.random() * 2) + 1;
							if (!loot.includes('WR') && randomRoll === 1) {
								loot.push('WR');
								rexLoot.push('WR');
								lootMSG.push(`**Warrior Ring:** ${rexKC.toLocaleString()} Rex KC <:Warrior_ring:421046902050783263>`);
							}
							if (!loot.includes('BR') && randomRoll === 2) {
								loot.push('BR');
								rexLoot.push('BR');
								lootMSG.push(`**Berserker Ring:** ${rexKC.toLocaleString()} Rex KC <:Berserker_ring:421046901773697035>`);
							}
						}
						if (!loot.includes('DA') && roll(128)) {
							loot.push('DA');
							...
							rexLoot.push('DA');
							primeLoot.push('DA');
							lootMSG.push(`**Dragon Axe:** ${rexKC.toLocaleString()} Rex KC <:Dragon_axe:405265921309933588>`);
						}
					}
					if (primeLoot.length !== 4) {
						...
						if (!loot.includes('DA') && roll(128)) {
							...
							rexLoot.push('DA');
							primeLoot.push('DA');
							lootMSG.push(`**Dragon Axe:** ${primeKC.toLocaleString()} Prime KC <:Dragon_axe:405265921309933588>`);
						}
					}
				}
				return msg.send(`
			...
			case 'DAGANNOTHREX': {
				...
				while (loot.length !== 4) {
					...
					if (roll(64)) {
						...
						if (!loot.includes('WR') && randomRoll === 1) {
							loot.push('WR');
							lootMSG.push(`**Warrior Ring:** ${kc.toLocaleString()} KC <:Warrior_ring:421046902050783263>`);
						}
						if (!loot.includes('BR') && randomRoll === 2) {
							loot.push('BR');
							lootMSG.push(`**Berserker Ring:** ${kc.toLocaleString()} KC <:Berserker_ring:421046901773697035>`);
						}
					}
					if (!loot.includes('DA') && roll(128)) {
						loot.push('DA');
			...
			case 'CHAOSELEMENTAL': {
				...
				while (loot.length !== 3) {
					...
					if (!loot.includes('PET') && roll(300)) {
						loot.push('PET');
						lootMSG.push(`**Pet Chaos Elemental:** ${kc.toLocaleString()} KC <:Pet_chaos_elemental:324127377070227456>`);
					}
					...
					if (!loot.includes('D2H') && roll(128)) {
						loot.push('D2H');
						lootMSG.push(`**Dragon 2h Sword:** ${kc.toLocaleString()} KC <:Dragon_2h_sword:405250171593818112>`);
					}
				}
				return msg.send(`
				...
				while (loot.length !== 5) {
					...
					if (roll(64)) {
						...
						if (!loot.includes('DC') && randomRoll === 1) {
							loot.push('DC');
							lootMSG.push(`**Dragon Chainbody:** ${kc.toLocaleString()} KC <:Dragon_chainbody:405250171719647232>`);
						}
...
${lootMSG.join('\n')}`);
			...
			case 'GRAARDOR': {
				...
				while (loot.length !== 8) {
					...
					if (!loot.includes('PET') && roll(5000)) {
						loot.push('PET');
						lootMSG.push(`**Pet General Graardor:** ${kc.toLocaleString()} KC <:Pet_general_graardor:324127377376673792>`);
					}
				...
				while (loot.length !== 8) {
					...
					if (roll(128)) {
						...
						if (!loot.includes('ACS') && randomRoll === 1) {
							loot.push('ACS');
							lootMSG.push(`**Armadyl Chainskirt:** ${kc.toLocaleString()} KC <:Armadyl_chainskirt:405262588222636042>`);
						}
						if (!loot.includes('ACP') && randomRoll === 2) {
							loot.push('ACP');
							lootMSG.push(`**Armadyl Chestplate:** ${kc.toLocaleString()} KC <:Armadyl_chestplate:405262588310454292>`);
						}
						if (!loot.includes('AHelm') && randomRoll === 3) {
							loot.push('AHelm');
							lootMSG.push(`**Armadyl Helmet:** ${kc.toLocaleString()} KC <:Armadyl_helmet:405262588499329024>`);
						}
					}
					if (roll(86)) {
						const randomRoll = Math.floor(Math.random() * 3) + 1;
...
${lootMSG.join('\n')}`);
			...
			case 'KRILTSUTSAROTH': {
				...
				while (loot.length !== 8) {
					...
					if (!loot.includes('PET') && roll(5000)) {
						loot.push('PET');
						lootMSG.push(`**Pet K'ril Tsutsaroth:** ${kc.toLocaleString()} KC <:Pet_kril_tsutsaroth:324127377527406594>`);
					}
					if (roll(256)) {
						const randomRoll = Math.floor(Math.random() * 2) + 1;
						if (!loot.includes('ZH') && randomRoll === 1) {
							loot.push('ZH');
							lootMSG.push(`**Zamorak Hilt:** ${kc.toLocaleString()} KC <:Zamorak_hilt:405251862489595905>`);
						}
						if (!loot.includes('SOTD') && randomRoll === 2) {
							loot.push('SOTD');
							lootMSG.push(`**Staff of the Dead:** ${kc.toLocaleString()} KC <:Staff_of_the_dead:405251862695116801>`);
						}
					}
					if (roll(64)) {
						const randomRoll = Math.floor(Math.random() * 2) + 1;
						if (!loot.includes('ZS') && randomRoll === 1) {
							loot.push('ZS');
							lootMSG.push(`**Zamorakian Spear:** ${kc.toLocaleString()} KC <:Zamorakian_spear:405251862883729418>`);
						}
						if (!loot.includes('SB') && randomRoll === 2) {
							loot.push('SB');
							lootMSG.push(`**Steam Battlestaff:** ${kc.toLocaleString()} KC <:Steam_battlestaff:405251862451716097>`);
						}
					}
					if (roll(86)) {
						const randomRoll = Math.floor(Math.random() * 3) + 1;
				...
				while (loot.length !== 8) {
					...
					if (roll(256)) {
						...
						if (!loot.includes('SH') && randomRoll === 1) {
							loot.push('SH');
							lootMSG.push(`**Saradomin Hilt:** ${kc.toLocaleString()} KC <:Saradomin_hilt:403051383214833667>`);
						}
						if (!loot.includes('ACB') && randomRoll === 2) {
							loot.push('ACB');
							lootMSG.push(`**Armadyl Crossbow:** ${kc.toLocaleString()} KC <:Armadyl_crossbow:403052160931069952>`);
						}
					}
					if (!loot.includes('SL') && roll(254)) {
						loot.push('SL');
						lootMSG.push(`**Saradomin's Light:** ${kc.toLocaleString()} KC <:Saradomins_light:403052160977338378>`);
					}
				...
				while (loot.length < 4) {
					...
					if (roll(5000)) {
						if (!loot.includes('PET')) {
							loot.push('PET');
							petKC = kc;
							lootMSG.push(`**Pet Dark Core:** ${petKC.toLocaleString()} KC <:Pet_dark_core:324127377347313674>`);
			...
			case 'ZULRAH': {
				...
				while (loot.length !== 8) {
					...
					if (!loot.includes('PET') && roll(4000)) {
						loot.push('PET');
						lootMSG.push(`**Pet Snakeling:** ${kc.toLocaleString()} KC <:Pet_snakeling:324127377816944642>`);
					}
					...
					if (roll(3277)) {
						...
						if (!loot.includes('TM') && randomRoll === 1) {
							loot.push('TM');
							lootMSG.push(`**Tanzanite Mutagen:** ${kc.toLocaleString()} KC <:Tanzanite_mutagen:403059676306079746>`);
						}
						if (!loot.includes('MM') && randomRoll === 2) {
							loot.push('MM');
							lootMSG.push(`**Magma Mutagen:** ${kc.toLocaleString()} KC <:Magma_mutagen:403059676733898753>`);
						}
					}
					if (roll(128)) {
						...
						if (!loot.includes('TF') && randomRoll === 1) {
							loot.push('TF');
							lootMSG.push(`**Tanzanite Fang:** ${kc.toLocaleString()} KC <:Tanzanite_fang:403059675979055105>`);
						}
						...
						if (!loot.includes('SV') && randomRoll === 3) {
							loot.push('SV');
							lootMSG.push(`**Serpentine Visage:** ${kc.toLocaleString()} KC <:Serpentine_visage:403059676016672769>`);
						}
			...
			case 'WT': {
				...
				while (loot.length !== 9) {
					...
					if (!loot.includes('TF') && roll(500)) {
						loot.push('TF');
						lootMSG.push(`**Tome of Fire:** ${kc.toLocaleString()} KC <:Tome_of_fire_empty:405265922287468544>`);
					}
					...
					if (roll(75)) {
						...
						if (!loot.includes('PG') && PC === 0) {
							loot.push('PG');
							lootMSG.push(`**Pyromancer Garb:** ${kc.toLocaleString()} KC <:Pyromancer_garb:405265922199257088>`);
							PC++;
							LOCK = true;
						}
						if (!loot.includes('PH') && LOCK === false) {
							loot.push('PH');
							lootMSG.push(`**Pyromancer Hood:** ${kc.toLocaleString()} KC <:Pyromancer_hood:405265921872232448>`);
							PC++;
							LOCK = true;
						}
						if (!loot.includes('PR') && LOCK === false) {
							loot.push('PR');
							lootMSG.push(`**Pyromancer Robe:** ${kc.toLocaleString()} KC <:Pyromancer_robe:405265921553334283>`);
							PC++;
							LOCK = true;
						}
						if (!loot.includes('PB') && LOCK === false) {
							loot.push('PB');
							lootMSG.push(`**Pyromancer Boots:** ${kc.toLocaleString()} KC <:Pyromancer_boots:405265921603534848>`);
							PC++;
							LOCK = true;
						}
					}
			...
			case 'VORKATH': {
				...
				while (loot.length !== 6) {
					...
					if (!loot.includes('DN') && roll(1000)) {
						loot.push('DN');
						lootMSG.push(`**Dragonbone Necklace:** ${kc.toLocaleString()} KC <:Dragonbone_necklace:403378090740547595>`);
					}
					if (roll(1500)) {
						const randomRoll = Math.floor(Math.random() * 2) + 1;
						if (!loot.includes('JD') && randomRoll === 1) {
							loot.push('JD');
							lootMSG.push(`**Jar of decay:** ${kc.toLocaleString()} KC <:Jar_of_decay:403378091008851968>`);
						}
					...
					if (roll(2500)) {
						...
						if (!loot.includes('SV') && randomRoll === 1) {
							loot.push('SV');
							lootMSG.push(`**Skeletal Visage:** ${kc.toLocaleString()} KC <:Skeletal_visage:403378091071766539>`);
						}
					...
					if (roll(50)) {
						if (vh === 0) {
							loot.push('VH');
							lootMSG.push(`**Vorkath's Head:** ${kc.toLocaleString()} KC <:Vorkaths_head:403378091046469632>`);
						}
						vh++;
					}
					if (kc === 50) {
			...
			case 'LIZARDMEN':	{
				...
				while (loot.length !== 2) {
					...
					if (!loot.includes('DWH') && roll(5000)) {
						loot.push('DWH');
						lootMSG.push(`**Dragon Warhammer:** ${kc.toLocaleString()} KC <:Dragon_warhammer:405998717154623488>`);
					}
				...
				while (loot.length !== 9) {
					...
					if (roll(250)) {
						...
						if (!loot.includes('BS') && randomRoll === 1) {
							loot.push('BS');
							lootMSG.push(`**Ballista Spring:** ${kc.toLocaleString()} KC <:Ballista_spring:405245077590507531>`);
						}
						if (!loot.includes('BL') && randomRoll === 2) {
							loot.push('BL');
							lootMSG.push(`**Balista Limbs** ${kc.toLocaleString()} KC <:Ballista_limbs:405245077280129025>`);
						}
					}
					if (roll(300)) {
			...
			case 'SKOTIZO': {
				...
				while (loot.length !== 4) {
					...
					if (!loot.includes('JD') && roll(2500)) {
						loot.push('JD');
						lootMSG.push(`**Jar of Darkness:** ${kc.toLocaleString()} KC <:Jar_of_darkness:417703738858536972>`);
					}
			...
			case 'VETION': {
				...
				while (loot.length !== 4) {
					...
					if (!loot.includes('ROTG') && roll(512)) {
						loot.push('ROTG');
						lootMSG.push(`**Ring of the Gods:** ${kc.toLocaleString()} KC <:Ring_of_the_gods:406002360947703808>`);
					}
					if (!loot.includes('D2H') && roll(256)) {
						loot.push('D2H');
						lootMSG.push(`**Dragon 2h Sword:** ${kc.toLocaleString()} KC <:Dragon_2h_sword:405250171593818112>`);
			...
			case 'VENENATIS': {
				...
				while (loot.length !== 4) {
					...
					if (!loot.includes('TR') && roll(512)) {
						loot.push('TR');
						lootMSG.push(`**Treasonous Ring:** ${kc.toLocaleString()} KC <:Treasonous_ring:406008615728578561>`);
					}
					if (!loot.includes('D2H') && roll(256)) {
						loot.push('D2H');
						lootMSG.push(`**Dragon 2h Sword:** ${kc.toLocaleString()} KC <:Dragon_2h_sword:405250171593818112>`);
...
${lootMSG.join('\n')}`);
			...
			case 'CALLISTO': {
				...
				while (loot.length !== 4) {
					...
					if (!loot.includes('TR') && roll(512)) {
						loot.push('TR');
						lootMSG.push(`**Tyrannical Ring:** ${kc.toLocaleString()} KC <:Tyrannical_ring:406000288290570260>`);
					}
					if (!loot.includes('D2H') && roll(256)) {
						loot.push('D2H');
						lootMSG.push(`**Dragon 2h Sword:** ${kc.toLocaleString()} KC <:Dragon_2h_sword:405250171593818112>`);
...
${lootMSG.join('\n')}`);
			...
			case 'SCORPIA': {
				...
				while (loot.length !== 3) {
					...
					if (!loot.includes('PET') && roll(2000)) {
						loot.push('PET');
						lootMSG.push(`**Scorpia's Offspring:** ${kc.toLocaleString()} KC <:Scorpias_offspring:324127378773377024>`);
					}
					if (roll(128)) {
						const randomRoll = Math.floor(Math.random() * 2) + 1;
						if (!loot.includes('OS3') && randomRoll === 1) {
							loot.push('OS3');
							lootMSG.push(`**Odium Shard 3:** ${kc.toLocaleString()} KC <:Odium_shard_3:417705570921873419>`);
						}
						if (!loot.includes('MS3') && randomRoll === 2) {
							loot.push('MS3');
							lootMSG.push(`**Malediction Shard 3:** ${kc.toLocaleString()} KC <:Malediction_shard_3:417705571173531658>`);
						}
					}
				}
				return msg.send(`
			...
			case 'DAWN': {
				...
				while (loot.length !== 6) {
					...
					if (!loot.includes('BTC') && roll(1000)) {
						loot.push('BTC');
						lootMSG.push(`**Black Tourmaline Core:** ${kc.toLocaleString()} KC <:Black_tourmaline_core:409989716063289354>`);
					}
					if (!loot.includes('GH') && roll(750)) {
						loot.push('GH');
						lootMSG.push(`**Granite Hammer:** ${kc.toLocaleString()} KC <:Granite_hammer:409989716134592532>`);
					}
					if (roll(250)) {
						const randomRoll = Math.floor(Math.random() * 2) + 1;
						if (!loot.includes('GR') && randomRoll === 1) {
							loot.push('GR');
							lootMSG.push(`**Granite Ring:** ${kc.toLocaleString()} KC <:Granite_ring:409989716151369729>`);
						}
						if (!loot.includes('GG') && randomRoll === 2) {
							loot.push('GG');
							lootMSG.push(`**Granite Gloves:** ${kc.toLocaleString()} KC <:Granite_gloves:409989716134592512>`);
						}
					}
				}
				return msg.send(`
				...
				while (loot.length !== 8) {
					...
					if (roll(100)) {
						...
						if (randomRoll >= 6 && randomRoll <= 15) {
							if (!loot.includes('AH')) {
								loot.push('AH');
								lootMSG.push(`**Abyssal head:** ${kc.toLocaleString()} KC <:Abyssal_head:412841187041345538>`);
							}
						}
						if (randomRoll >= 16 && randomRoll <= 27) {
							if (!loot.includes('AW')) {
								loot.push('AW');
								lootMSG.push(`**Abyssal whip:** ${kc.toLocaleString()} KC <:Abyssal_whip:403386370686582804>`);
							}
						}
						if (randomRoll >= 28 && randomRoll <= 40) {
							if (!loot.includes('JM')) {
								loot.push('JM');
								lootMSG.push(`**Jar of miasma:** ${kc.toLocaleString()} KC <:Jar_of_miasma:412841187331014657>`);
							}
						}
						if (randomRoll >= 41 && randomRoll <= 66) {
							if (!loot.includes('AD')) {
								loot.push('AD');
								lootMSG.push(`**Abyssal Dagger:** ${kc.toLocaleString()} KC <:Abyssal_dagger:403386370388918273>`);
							}
						}
			...
			case 'KRAKEN': {
				...
				while (loot.length !== 4) {
					...
					if (!loot.includes('KT') && roll(300)) {
						loot.push('KT');
						lootMSG.push(`**Kraken Tentacle:** ${kc.toLocaleString()} KC <:Kraken_tentacle:421042619859337216>`);
					}
					if (!loot.includes('TOTS') && roll(512)) {
						loot.push('TOTS');
						lootMSG.push(`**Trident of the Seas:** ${kc.toLocaleString()} KC <:Trident_of_the_seas:421042619913863198>`);
					}
				}
				return msg.send(`
				...
				while (loot.length !== 6) {
					...
					if (roll(128)) {
						...
						if (!loot.includes('PRIMC') && randomRoll === 1) {
							loot.push('PRIMC');
							lootMSG.push(`**Primordial Crystal:** ${kc.toLocaleString()} KC <:Primordial_crystal:403380366888665088>`);
						}
						if (!loot.includes('PEGC') && randomRoll === 2) {
							loot.push('PEGC');
							lootMSG.push(`**Pegasian Crystal:** ${kc.toLocaleString()} KC <:Pegasian_crystal:403380366611578891>`);
						}
						if (!loot.includes('EC') && randomRoll === 3) {
							loot.push('EC');
							lootMSG.push(`**Eternal Crystal** ${kc.toLocaleString()} KC <:Eternal_crystal:403380366808973312>`);
						}
						if (!loot.includes('SS') && randomRoll === 4) {
							loot.push('SS');
							lootMSG.push(`**Smouldering Stone:** ${kc.toLocaleString()} KC <:Smouldering_stone:403380366657978400>`);
						}
					}
				}
				return msg.send(`
			...
			case 'THERMONUCLEARSMOKEDEVIL': {
				...
				while (loot.length !== 4) {
					...
					if (!loot.includes('SB') && roll(512)) {
						loot.push('SB');
						lootMSG.push(`**Smoke Battlestaff:** ${kc.toLocaleString()} KC <:Smoke_battlestaff:412845709575061506>`);
					}
					if (!loot.includes('PET') && roll(3000)) {
						loot.push('PET');
					...
					if (!loot.includes('ON') && roll(350)) {
						loot.push('ON');
						lootMSG.push(`**Occult Necklace:** ${kc.toLocaleString()} KC <:Occult_necklace:412845632089358336>`);
					}
